...
export default function Header() {
  const cartStore = useCartStore();
    return (
        <header className="flex  bg-gray-100 font-areaNormal justify-center px-12">
          <div className="flex justify-between items-center p-4 w-full  max-w-[90%] lg:max-w-[1172px]">
